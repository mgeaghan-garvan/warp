...
task zCall {
  ...
  runtime {
    docker: "australia-southeast1-docker.pkg.dev/pb-dev-312200/nagim-images/zcall:4.0.1-1.3-1629910423"
...
task BpmToNormalizationManifestCsv {
  ...
  runtime {
    docker: "australia-southeast1-docker.pkg.dev/pb-dev-312200/nagim-images/picard-cloud:2.25.5"
    disks: "local-disk 10 HDD"
    memory: "7.5 GiB"
    cpu: 2
    preemptible: preemptible_tries
...
task BafRegress {
  ...
  runtime {
    docker: "australia-southeast1-docker.pkg.dev/pb-dev-312200/nagim-images/bafregress:1.0"
    disks: "local-disk " + disk_size + " HDD"
    memory: "3.5 GiB"
    preemptible: preemptible_tries
  }
...
task VerifyIDIntensity {
  ...
  runtime {
    docker: "australia-southeast1-docker.pkg.dev/pb-dev-312200/nagim-images/verify-id-intensity:e6354872834fe4262354a6b27bfe85ecc1323677-1561566044"
    disks: "local-disk " + disk_size + " HDD"
    memory: "3.5 GiB"
    preemptible: preemptible_tries
  }
...
task SelectVariants {
  ...
  runtime {
    docker: "australia-southeast1-docker.pkg.dev/pb-dev-312200/nagim-images/gatk:4.1.3.0"
    disks: "local-disk " + disk_size + " HDD"
    memory: "3.5 GiB"
    preemptible: preemptible_tries
  }
...
task AutoCall {
  ...
  runtime {
    docker: "australia-southeast1-docker.pkg.dev/pb-dev-312200/nagim-images/illumina-iaap-autocall:1.0.2-1.1.0-1629910298"
    disks: "local-disk " + disk_size + " HDD"
    memory: "7 GiB"
    preemptible: preemptible_tries
  }

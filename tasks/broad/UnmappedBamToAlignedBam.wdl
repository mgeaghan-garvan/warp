...
workflow UnmappedBamToAlignedBam {
  ...
  output {
    ...
    File? cross_check_fingerprints_metrics = MarkDuplicates.duplicate_metrics # TODO changed for test

    File selfSM = MarkDuplicates.duplicate_metrics # TODO changed for test
    Float contamination = 0 # TODO changed for test
